...
const EditByIdCourse = ({onclose, oncheck , course}) => {
...
console.log(course)
  ...
  const HandleSubmit = async (e) => {
    ...
    }/Schedule/Lecture/UpdateCourse/${CourseId}`;
              ...
              <div>
                {
                  data?.image && (
                    <div>
                    <img className='w-32 h-32 p-1 rounded-full' src={data?.image} />
                    </div>
                  )
                }
              </div>
